...
const Header = () => {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white flex items-center h-16 px-3">
            ...
            <div className="flex items-center space-x-2">
                ...
                {/* Sidebar */}
                <div
                    className={`fixed right-0 top-0 h-full w-64 bg-white z-50 transform transition-transform ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'
                        } md:static md:translate-x-0 md:h-auto md:w-auto md:bg-transparent md:flex md:items-center`}
                >
